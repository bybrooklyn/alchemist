...
This file is the repository's canonical instruction and technical guidance.
...
**Stack:** Rust (Axum + SQLite/sqlx + tokio) backend, Astro 7 + React 19 + TypeScript frontend.

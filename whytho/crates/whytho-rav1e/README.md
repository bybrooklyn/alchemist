...
> **Note:** This crate (workspace name `whytho-rav1e`) is a hard fork absorbed
> into the [WhyTho](../../README.md) workspace, forked from
> [xiph/rav1e](https://github.com/xiph/rav1e) at commit
> `564ae3b0007ae2b06893fd7166bf88c5a84c5b63`. It is developed in place as part
> of WhyTho going forward rather than tracked against upstream. The original
> BSD-2-Clause license and AOM Patent License grant are preserved unmodified
> (see `LICENSE`, `PATENTS`, and the workspace [`NOTICE`](../../NOTICE)) — the
> text below is the original upstream README, describing the encoder itself.
> The badges above point at the upstream project's CI/coverage, not this fork's.
